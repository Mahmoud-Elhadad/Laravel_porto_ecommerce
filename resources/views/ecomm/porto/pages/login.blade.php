...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 12:54:09 GMT -->
...
<body>
								...
								<div class="dropdownmenu-wrapper custom-scrollbar">
									...
									<div class="dropdown-cart-products">
										<div class="product">
											...
											<figure class="product-image-container">
												<a href="product.html" class="product-image">
													<img src="{{asset("porto")}}/images/products/product-1.jpg" alt="product"
														width="80" height="80">
												</a>
										...
										<div class="product">
											...
											<figure class="product-image-container">
												<a href="product.html" class="product-image">
													<img src="{{asset("porto")}}/images/products/product-2.jpg" alt="product"
														width="80" height="80">
												</a>
										...
										<div class="product">
											...
											<figure class="product-image-container">
												<a href="product.html" class="product-image">
													<img src="{{asset("porto")}}/images/products/product-3.jpg" alt="product"
														width="80" height="80">
												</a>
												<a href="#" class="btn-remove" title="Remove Product"><span>×</span></a>
											</figure>
									...
									<div class="row">
										...
										<div class="col-lg-4 p-0">
											<div class="menu-banner">
												<figure>
													<img src="{{asset("porto")}}/images/menu-banner.jpg" width="192" height="313"
														alt="Menu banner">
												</figure>
									...
									<div class="row">
										...
										<div class="col-lg-4 p-0">
											<div class="menu-banner menu-banner-2">
												<figure>
													<img src="{{asset("porto")}}/images/menu-banner-1.jpg" width="182" height="317"
					...
					<div class="col-lg-10 mx-auto">
						<div class="row">
							<div class="col-md-12">
                                ...
                                <div class="alert alert-danger">{{ session("message_login") }}</div>
                                @endif
								<form action="{{ route("porto.login.check") }}" method="post">
                                    @csrf
									...
									<div class="form-footer" style="display: flex; justify-content: space-between; align-items: center;">
                                        ...
                                        <div>
                                           <span class=" text-dark" style="font-size: 14px"> Don't have an account?</span>
                                            <a  href="{{ route("porto.register") }}"
                                                class="forget-password  form-footer-right m-0 p-0">Sign up</a>
                                        </div>
                                        </div>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="widget">
								...
								<ul class="contact-info">
									...
									<li>
										<span class="contact-info-label">Email:</span> <a href="https://portotheme.com/cdn-cgi/l/email-protection#dab7bbb3b69abfa2bbb7aab6bff4b9b5b7"><span class="__cf_email__" data-cfemail="f499959d98b4918c9599849891da979b99">[email&#160;protected]</span></a>
									</li>
									<li>
		...
		<div class="mobile-menu-wrapper">
			...
			<nav class="mobile-nav">
				<ul class="mobile-menu">
					<li><a href="{{ route("porto.index") }}">Home</a></li>
					<li>
						<a href="category.html">Categories</a>
						<ul>
	...
	<!-- Plugins JS File -->
	<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="{{asset("porto")}}/js/jquery.min.js"></script>
...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 12:54:10 GMT -->
</html>
