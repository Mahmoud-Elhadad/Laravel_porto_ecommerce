                            ...
                            <div class="blog-section row">
                                <div class="col-md-6 col-lg-4">
                                    <article class="post">
                                        <div class="post-media">
                                            <a href="single.html">
                                                <img src="{{asset('porto')}}/images/blog/home/post-1.jpg" alt="Post" width="225"
                                                    height="280">
                                            </a>
                                            <div class="post-date">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <article class="post">
                                        <div class="post-media">
                                            <a href="single.html">
                                                <img src="{{asset('porto')}}/images/blog/home/post-2.jpg" alt="Post" width="225"
                                                    height="280">
                                            </a>
                                            <div class="post-date">
                                                <span class="day">26</span>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <article class="post">
                                        <div class="post-media">
                                            <a href="single.html">
                                                <img src="{{asset('porto')}}/images/blog/home/post-3.jpg" alt="Post" width="225"
                                                    height="280">
                                            </a>
                                            <div class="post-date">
                                                <span class="day">26</span>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <article class="post">
                                        <div class="post-media">
                                            <a href="single.html">
                                                <img src="{{asset('porto')}}/images/blog/home/post-4.jpg" alt="Post" width="225"
                                                    height="280">
                                            </a>
                                            <div class="post-date">
                                                <span class="day">26</span>
                                ...
                                <div class="widget widget-post">
                                    ...
                                    <ul class="simple-post-list">
                                        <li>
                                            <div class="post-media">
                                                <a href="single.html">
                                                    <img src="{{asset('porto')}}/images/blog/widget/post-1.jpg" alt="Post">
                                                </a>
                                            </div><!-- End .post-media -->
                                            <div class="post-info">
                                                <a href="single.html">Top New Collection</a>
                                        ...
                                        <li>
                                            <div class="post-media">
                                                <a href="single.html">
                                                    <img src="{{asset('porto')}}/images/blog/widget/post-2.jpg" alt="Post">
                                                </a>
                                            </div><!-- End .post-media -->
                                            <div class="post-info">
                                                <a href="single.html">Fashion Trends</a>
