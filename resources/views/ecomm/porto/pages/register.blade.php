					...
					<div class="col-lg-10 mx-auto">
						<div class="row">
							...
							<div class="col-md-12">
								...
								<form action="{{ route("porto.user.add") }}" method="post">
                                    @csrf
									...
									<input type="text" name="name" class="form-input form-wide" id="register-name"  />
									...
									<input type="password" name="confirm" class="form-input form-wide" id="confirm"	 />
