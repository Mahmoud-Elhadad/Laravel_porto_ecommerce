...
<!-- Mirrored from htmldemo.net/antomi/antomi/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Sep 2025 22:42:33 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset("antomi")}}/assets/img/favicon.ico">

    <!-- CSS
    ========================= -->

    <!-- Plugins CSS -->
    <link rel="stylesheet" href="{{asset("antomi")}}/assets/css/plugins.css">

    <!-- Main Style CSS -->
    <link rel="stylesheet" href="{{asset("antomi")}}/assets/css/style.css">
        ...
        <div class="main_header">
            <div class="container">
                ...
                <div class="header_middle sticky-header">
                    <div class="row align-items-center">
                        <div class="col-lg-2 col-md-3 col-4">
                            <div class="logo">
                                <a href="index-2.html"><img src="{{asset("antomi")}}/assets/img/logo/logo.png" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-12">
                            <div class="main_menu menu_position text-center">
                                <nav>
                                    <ul>
                                        <li><a class="active" href="index-2.html">home<i class="fa fa-angle-down"></i></a>
                                            <ul class="sub_menu">
                                                <li><a href="index-2.html">Home shop 1</a></li>
                                                <li><a href="index-3.html">Home shop 2</a></li>
                                                <li><a href="index-4.html">Home shop 3</a></li>
                                                <li><a href="index-5.html">Home shop 4</a></li>
                                                <li><a href="index-6.html">Home shop 5</a></li>
                                                <li><a href="index-7.html">Home shop 6</a></li>
                                                <li><a href="index-8.html">Home shop 7</a></li>
                                            </ul>
                                        </li>
                ...
                <div class="mini_cart">
                    ...
                    <div class="cart_item">
                        <div class="cart_img">
                            <a href="#"><img src="{{asset("antomi")}}/assets/img/s-product/product.jpg" alt=""></a>
                        </div>
                        <div class="cart_info">
                    ...
                    <div class="cart_item">
                        <div class="cart_img">
                            <a href="#"><img src="{{asset("antomi")}}/assets/img/s-product/product2.jpg" alt=""></a>
                        </div>
                        <div class="cart_info">
